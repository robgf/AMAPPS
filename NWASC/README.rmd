...
This will most likely be simple data checks (e.g. do species codes match those in the catalog, are the gps coordinates in latitude and longitude units) - data should be cleaned by the data provider before submission
