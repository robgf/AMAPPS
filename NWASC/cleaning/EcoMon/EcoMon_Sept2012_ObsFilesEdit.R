...
# load data 
#---------------------#
db = odbcConnectExcel2007(file.path(dir.in, "OffshoreSurveyDataCleandProcessd2012.xlsx")) 
obs = sqlFetch(db, "PC120913-121018final")
odbcClose(db)
#---------------------#
