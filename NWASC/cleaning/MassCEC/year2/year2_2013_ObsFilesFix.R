...
obs$seat[obs$seat=="right"]="rr"
obs$seat[obs$seat=="lbrb"]="lrrr"
...
changes = c("TRAWL","TRAWLER","DRAGGER","DOLPHIN","DOLPHINS","GPS","TANKER","CARGOSHIP","ROCKWEED",
            ...
            "BRANT","DDCO","JASP","LBTU","OLD","STTE","ULGU","ULSH")
...
obs$month[basename(obs$file)=="survey17_TRACK_TR033013"] = 3
obs$year[basename(obs$file)=="survey17_TRACK_TR033013"] = 2013
obs$day[basename(obs$file)=="survey17_TRACK_TR033013"] = 30
