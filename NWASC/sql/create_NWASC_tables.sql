...
INSERT INTO lu_species(
	...
	VALUES
	(1,'ABDH','American Black Duck X Mallard Hybrid','Anas rubripes x platy.',NULL, NULL, NULL, NULL),
	...
	(1,'AMKE','American Kestrel',NULL,'Falco','sparverius',175622, NULL),
	(1,'AMOY','American Oystercatcher',NULL,'Haematopus','palliatus',176472, NULL),
	(1,'AMPI','American Pipit',NULL,'Anthus','rubescens',554127, NULL),
	...
	(1,'BBCU','Black-billed Cuckoo',NULL,'Coccyzus','erythropthalmus',177834, NULL),
	...
	(1,'BEKI','Belted Kingfisher',NULL,'Megaceryle','alcyon',178106, NULL),
	...
	(1,'BOBO','Bobolink',NULL,'Dolichonyx','oryzivorus',179032, NULL),
	(1,'BOGU','Bonaparte''s Gull',NULL,'Larus','philadelphia',176839, NULL),
	(1,'BOWA','Bohemian Waxwing',NULL,'Bombycilla','garrulus',178529, NULL),
	(1,'BRAN','Brant',NULL,'Branta','bernicla',175011, NULL),
	(1,'BRBL','Brewer''s Blackbird',NULL,'Euphagus','cyanocephalus',179094, NULL),
	(1,'BRBO','Brown Booby',NULL,'Sula','leucogaster',174704, NULL),
	(1,'BRCR','Brown Creeper',NULL,'Certhia','americana',178803, NULL),
	...
	(1,'BRTH','Brown Thrasher',NULL,'Toxostoma','rufum',178627, NULL),
	(1,'BTGU','Black-tailed Gull',NULL,'Larus','crassirostris',176831, NULL),
	(1,'BTNW','Black-throated Green Warbler',NULL,'Dendroica','virens',178898, NULL),
	(1,'BUFF','Bufflehead',NULL,'Bucephala','albeola',175145, NULL),
	(1,'BUPE','Bulwer''s Petrel',NULL,'Bulweria','bulweria',554144, NULL),
	(1,'BUTE','Unidentified Buteo','Buteo',NULL,NULL,175349, NULL),
	...
	(1,'CACH','Carolina Chickadee',NULL,'Poecile','carolinensis',554383, NULL),
	...
	(1,'CHSW','Chimney Swift',NULL,'Chaetura','pelagica',178001, NULL),
	(1,'CLRA','Clapper Rail',NULL,'Rallus','longirostris',176209,'Formerly considered conspecific with Rallus longirostris'),
	(1,'CLSW','Cliff Swallow',NULL,'Petrochelidon','pyrrhonota',178455, NULL),
	...
	(1,'COYE','Common Yellowthroat',NULL,'Geothlypis','trichas',178944, NULL),
	...
	(1,'DEJU','Dark-eyed Junco',NULL,'Junco','hyemalis',179410, NULL),
	...
	(1,'EAKI','Eastern Kingbird',NULL,'Tyrannus','tyrannus',178279, NULL),
	(1,'EAME','Eastern Meadowlark',NULL,'Sturnella','magna',179034, NULL),
	(1,'EAPH','Eastern Phoebe',NULL,'Sayornis','phoebe',178329, NULL),
	(1,'EASO','Eastern Screech-Owl',NULL,'Megascops','asio',686658, NULL),
	(1,'EATO','Eastern Towhee',NULL,'Pipilo','erythrophthalmus',179276, NULL),
	(1,'EISC','Unidentified Eider/Scoter spp.','Melanitta/Somateria spp.',NULL,NULL,NULL, NULL),
	(1,'EUCD','Eurasian Collared-Dove',NULL,'Streptopelia','decaocto',177139, NULL),
	...
	(1,'EVGR','Evening Grosbeak',NULL,'Coccothraustes','vespertinus',179173, NULL),
	...
	(1,'FICR','Fish Crow',NULL,'Corvus','ossifragus',179737, NULL),
	...
	(1,'GCKI','Golden-crowned Kinglet',NULL,'Regulus','satrapa',179865, NULL),
	...
	(1,'GRAJ','Gray Jay',NULL,'Perisoreus','canadensis',179667, NULL),
	(1,'GRAK','Gray Kingbird',NULL,'Tyrannus','dominicensis',178280, NULL),
	...
	(1,'INBU','Indigo Bunting',NULL,'Passerina','cyanea',179150, NULL),
	...
	(1,'JUNC','Unidentified junco',NULL,NULL,NULL,179409, NULL),
	...
	(1,'LALO','Lapland Longspur',NULL,'Calcarius','lapponicus',179526, NULL),
	...
	(1,'LISP','Lincoln''s Sparrow',NULL,'Melospiza','lincolnii',179484, NULL),
	(1,'LITE','Little Tern',NULL,'Sternula','albifrons',824124, NULL),
	(1,'LONG','Unidentified Longspur','Calcarius spp.','Calcarius',NULL,179524, NULL),
	(1,'LOSH','Loggerhead Shrike',NULL,'Lanius','ludovicianus',178515, NULL),
	...
	(1,'MEAD','Unidentified Meadowlark','Sturnella spp.','Sturnella',NULL,179033, NULL),
	(1,'MEGU','Mew Gull',NULL,'Larus','canus',176832, NULL),
	(1,'MERL','Merlin',NULL,'Falco','columbarius',175613, NULL),
	(1,'MOPL','Mountain Plover',NULL,'Charadrius','montanus',176522, NULL),
	(1,'NOBO','Northern Bobwhite',NULL,'Colinus','virginianus',175863, NULL),
	(1,'NOFL','Northern Flicker',NULL,'Colaptes','auratus',178154, NULL),
	...
	(1,'OSPR','Osprey',NULL,'Pandion','haliaetus',175590,NULL),
	...
	(1,'RCKI','Ruby-crowned Kinglet',NULL,'Regulus','calendula',179870,NULL),
	(1,'RECR','Red Crossbill',NULL,'Loxia','curvirostra',179259,NULL),
	(1,'REDH','Redhead',NULL,'Aythya','americana',175125,NULL),
	(1,'REDP','Common or Hoary Redpoll','Carduelis flammea/hornemanni',NULL,NULL,NULL,NULL),
	...
	(1,'ROSW','Rough-Winged Swallow',NULL,'Stelgidopteryx',NULL,178439,NULL),
	...
	(1,'RUBL','Rusty Blackbird',NULL,'Euphagus','carolinus',179091,NULL),
	(1,'RUDU','Ruddy Duck',NULL,'Oxyura','jamaicensis',175175,NULL),
	(1,'RUTU','Ruddy Turnstone',NULL,'Arenaria','interpres',176571,NULL),
	(1,'RWBL','Red-winged Blackbird',NULL,'Agelaius','phoeniceus',179045,NULL),
	...
	(1,'SEOW','Short-eared Owl',NULL,'Asio','flammeus',177935,NULL),
	...
	(1,'SNBU','Snow Bunting',NULL,'Plectrophenax','nivalis',179532,NULL),
	...
	(1,'SNOW','Snowy Owl',NULL,'Bubo','scandiacus',686683,NULL),
	...
	(1,'SPGR','Spruce Grouse',NULL,'Falcipennis','canadensis',553896,NULL),
	(1,'SPGU','Spectacled Guillemot',NULL,'Cepphus','carbo',176994,NULL),
	(1,'SPPI','Sprague''s Pipit',NULL,'Anthus','spragueii',178499,NULL),
	...
	(1,'UCRT','Unidentified Common or Roseate Tern','Sterna hirundo/dougallii',NULL,NULL,NULL,NULL,NULL),--includes CRTE (same meaning) which was removed
	...
	(1,'UNAM','Unidentified Seaside or Sharptailed Sparrow','Ammodramus spp.','Ammodramus',NULL,179332,NULL),
	(1,'UNBI','Unidentified Bird','Aves',NULL,NULL,174371,NULL),
	(1,'UNBL','Unidentified Blackbird','Icteridae spp.',NULL,NULL,179030,NULL),
	...
	(1,'UNFI','Unidentified Finch','Carduelis spp.','Carduelis',NULL,179225,NULL),
	...
	(1,'UNPA','Unidentified Passerine (perching birds, songbirds)',NULL,NULL,NULL,NULL,NULL),
	...
	(1,'UNRP','Unidentified Raptor/ bird of prey',NULL,NULL,NULL,NULL,NULL),
	...
	(1,'UNSS','Unidentified Small Shearwater (Audubon''s, Manx, or Little)','Puffinus lherminieri , P. puffinus, or P. assimilis','Puffinus',NULL,NULL,NULL,NULL),
	(1,'UNST','Unidentified small Tern',NULL,NULL,NULL,NULL,NULL),
	(1,'UNSU','Unidentified Sulid','Sulidae spp.',NULL,NULL,174696,NULL),
	(1,'UNTA','Unidentified Tanager',NULL,NULL,NULL,NULL,NULL),
	(1,'UNTB','Unidentified Tropicbird','Phaethon spp.','Phaethon',NULL,174672,NULL),
	(1,'UNTE','Unidentified Tern',NULL,NULL,NULL,NULL,NULL),
	(1,'UNTH','Unidentified Thrush','Turdidae spp.',NULL,NULL,179751,NULL),
	...
	(1,'USAC','Unidentified small Accipiter',NULL,NULL,NULL,NULL,NULL),
	...
	(1,'WIWA','Wilson''s Warbler',NULL,'Wilsonia','pusilla',178973,NULL),
	(1,'WIWR','Winter Wren',NULL,'Troglodytes','troglodytes',178547,NULL),
	(1,'WODU','Wood Duck',NULL,'Aix','sponsa',175122,NULL),
	(1,'WOTH','Wood Thrush',NULL,'Hylocichla','mustelina',179777,NULL),
	...
	(1,'WWCR','White-winged Crossbill',NULL,'Loxia','leucoptera',179268,NULL),
	...
	(1,'YHBL','Yellow-headed Blackbird',NULL,'Xanthocephalus','xanthocephalus',179043,NULL),
	...
	(2,'BBWH','Blainville''s Beaked Whale',NULL,'Mesoplodon','densirstris',NULL,NULL),
 	...
 	(2,'SPDO','Unidentified Spotted Dolphins (Atlantic or Pantropical)','Stenella',NULL,180428,NULL),
	...
	(4,'OWTS','Oceanic Whitetip Shark (aka. Brown shark, brown Milbert''s sand bar shark, nigano shark, silvertip shark)','Carcharhinus','longimanus',160330,NULL),
	...
	(7,'BOCF','Boat-Commercial fishing',NULL,NULL,NULL),
	...
	(8,'CHIC','Unidentified Chickadee',NULL,NULL,NULL,NULL,NULL,NULL),
