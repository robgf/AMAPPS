...
--dataset_summary, dataset_quality, dataset_processing)
	VALUES
	(141,1,'AMAPPS_FWS_Aerial_Fall2012','a','cts','ot',400,200,5,'yes','no',50,'BOEM,USFWS,NOAA,NAVY',110),
	(142,1,'AMAPPS_FWS_Aerial_Fall2013','a','cts','ot',400,200,5,'yes','no',64,'BOEM,USFWS,NOAA,NAVY',110),
	(164,1,'AMAPPS_FWS_Aerial_Fall2014','a','cts','ot',400,200,5,'yes','no',64,'BOEM,USFWS,NOAA,NAVY',110),
	(118,1,'AMAPPS_FWS_Aerial_Preliminary_Summer2010','a','cts','ot',400,200,5,'yes','no',50,'BOEM,USFWS,NOAA,NAVY',110),
	(140,1,'AMAPPS_FWS_Aerial_Spring2012','a','cts','ot',400,200,5,'yes','no',50,'BOEM,USFWS,NOAA,NAVY',110),
	(138,1,'AMAPPS_FWS_Aerial_Summer2011','a','cts','ot',400,200,5,'yes','no',50,'BOEM,USFWS,NOAA,NAVY',110),
	(137,1,'AMAPPS_FWS_Aerial_Winter2010-2011','a','cts','ot',400,200,5,'yes','no',50,'BOEM,USFWS,NOAA,NAVY',110),
	(139,1,'AMAPPS_FWS_Aerial_Winter2014','a','cts','ot',400,200,5,'yes','no',64,'BOEM,USFWS,NOAA,NAVY',110),
	(117,2,'AMAPPS_NOAA/NMFS_NEFSCBoat2011','b','cts','ot',300,300,5,'yes','yes',55,'BOEM,USFWS,NOAA,NAVY',NULL),
	(116,2,'AMAPPS_NOAA/NMFS_NEFSCBoat2013','b','cts','ot',300,300,5,'yes','yes',55,'BOEM,USFWS,NOAA,NAVY',NULL),
	(149,2,'AMAPPS_NOAA/NMFS_NEFSCBoat2014','b','cts','ot',300,300,5,'yes','yes',55,'BOEM,USFWS,NOAA,NAVY',NULL),
	(160,2,'AMAPPS_NOAA/NMFS_NEFSCBoat2015','b','cts','ot',300,300,5,'yes','yes',52,'BOEM,USFWS,NOAA,NAVY',NULL),
	(174,2,'AMAPPS_NOAA/NMFS_NEFSCBoat2016','b','cts','ot',300,300,9,'no','yes',52,'BOEM,USFWS,NOAA,NAVY',NULL),
	(122,2,'AMAPPS_NOAA/NMFS_SEFSCBoat2011','b','cts','ot',300,300,5,'yes','yes',55,'BOEM,USFWS,NOAA,NAVY',NULL),
	(123,2,'AMAPPS_NOAA/NMFS_SEFSCBoat2013','b','cts','ot',300,300,5,'yes','yes',55,'BOEM,USFWS,NOAA,NAVY',NULL),
	(100,NULL,'AtlanticFlywaySeaducks1991',NULL,NULL,NULL,NULL,NULL,0,'no',NULL,NULL,'USFWS',NULL),				
	(43,3,'AudubonCBC_MA2Z','g','cbc','og',NULL,NULL,5,'yes','yes',8,NULL,NULL),        		
	(46,3,'AudubonCBC_MASB','g','cbc','og',NULL,NULL,5,'yes','yes',8,NULL,NULL),         		
	(47,3,'AudubonCBC_MD15','g','cbc','og',NULL,NULL,5,'yes','yes',8,NULL,NULL),         		
	(48,3,'AudubonCBC_MD19','g','cbc','og',NULL,NULL,5,'yes','yes',8,NULL,NULL),         		
	(49,3,'AudubonCBC_MDBH','g','cbc','og',NULL,NULL,5,'yes','yes',8,NULL,NULL),         		
	(50,3,'AudubonCBC_MDJB','g','cbc','og',NULL,NULL,5,'yes','yes',8,NULL,NULL),         		
	(51,3,'AudubonCBC_ME08','g','cbc','og',NULL,NULL,5,'yes','yes',8,NULL,NULL),         		
	(52,3,'AudubonCBC_ME0A','g','cbc','og',NULL,NULL,5,'yes','yes',8,NULL,NULL),         		
	(53,3,'AudubonCBC_ME0B','g','cbc','og',NULL,NULL,5,'yes','yes',8,NULL,NULL),         		
	(54,3,'AudubonCBC_MEBF','g','cbc','og',NULL,NULL,5,'yes','yes',8,NULL,NULL),         		
	(55,3,'AudubonCBC_MEMB','g','cbc','og',NULL,NULL,5,'yes','yes',8,NULL,NULL),         		
	(56,3,'AudubonCBC_NJ0A','g','cbc','og',NULL,NULL,5,'yes','yes',8,NULL,NULL),         		
	(57,3,'AudubonCBC_NJ0R','g','cbc','og',NULL,NULL,5,'yes','yes',8,NULL,NULL),         		
	(58,3,'AudubonCBC_NJ0S','g','cbc','og',NULL,NULL,5,'yes','yes',8,NULL,NULL),         		
	(59,3,'AudubonCBC_NJAO','g','cbc','og',NULL,NULL,5,'yes','yes',8,NULL,NULL),         		
	(60,3,'AudubonCBC_NJNJ','g','cbc','og',NULL,NULL,5,'yes','yes',8,NULL,NULL),         		
	(61,3,'AudubonCBC_NY1Q','g','cbc','og',NULL,NULL,5,'yes','yes',7,NULL,NULL),         		
	(62,3,'AudubonCBC_NY1R','g','cbc','og',NULL,NULL,5,'yes','yes',8,NULL,NULL),         		
	(63,3,'AudubonCBC_NY1S','g','cbc','og',NULL,NULL,5,'yes','yes',8,NULL,NULL),         		
	(64,3,'AudubonCBC_NY1W','g','cbc','og',NULL,NULL,5,'yes','yes',8,NULL,NULL),         		
	(65,3,'AudubonCBC_NY1X','g','cbc','og',NULL,NULL,5,'yes','yes',8,NULL,NULL),         		
	(66,3,'AudubonCBC_NY21','g','cbc','og',NULL,NULL,5,'yes','yes',8,NULL,NULL),         		
	(67,3,'AudubonCBC_NY39','g','cbc','og',NULL,NULL,5,'yes','yes',8,NULL,NULL),         		
	(68,3,'AudubonCBC_VACB','g','cbc','og',NULL,NULL,5,'yes','yes',8,NULL,NULL),         		
	(107,NULL,'AvalonSeawatch1993',NULL,NULL,NULL,NULL,NULL,0,'no',NULL,21,NULL,NULL), 					
	(5,4,'BarHarborWW05','b','cts','ot',NULL,NULL,5,'yes','yes',33,'USFWS',NULL),         		
	(6,4,'BarHarborWW06','b','cts','ot',NULL,NULL,5,'yes','yes',33,'USFWS',NULL),         		
	(166,4,'BarHarborWW09','b','cts','ot',NULL,NULL,0,'no',NULL,33,'USFWS',NULL), 		
	(167,4,'BarHarborWW10','b','cts','ot',NULL,NULL,0,'no',NULL,33,'USFWS',NULL), 		
	(103,NULL,'BluewaterWindDE',NULL,NULL,NULL,NULL,NULL,0,'no',NULL,40,'BOEM',NULL), 					
	(102,NULL,'BluewaterWindNJ',NULL,NULL,NULL,NULL,NULL,0,'no',NULL,40,'BOEM',NULL), 					
	(144,5,'BOEMHighDef_NC2011Aerial','a','cts','ot',500,250,5,'yes','no',61,'BOEM,Normandeau',NULL), 
	(143,5,'BOEMHighDef_NC2011Boat','b','cts','ot',1000,1000,5,'yes','no',61,'BOEM,Normandeau',NULL), 
	(169,5,'BOEMHighDef_NC2011Camera','c','cts','ot',NULL,NULL,99,'no','yes',61,'BOEM,Normandeau',NULL), 		
	(145,16,'BOEMNanoTag_Mass_Aug2013','a','tss','ot',400,200,99,'no','yes',60,'BOEM,USFWS',110), 			
	(172,NULL,'BRIMaine2016','b','cts','ot',NULL,NULL,9,'no',NULL,66,'BRI,Maine gov',NULL), 		
	(7,NULL,'CapeHatteras0405','b','cts','ot',NULL,NULL,5,'yes',NULL,23,'Duke',NULL),         		
	(8,NULL,'CapeWindAerial','a','cts','ot',NULL,NULL,2,'yes','yes',13,'BOEM',NULL),       		
	(9,NULL,'CapeWindBoat','b','cts','ot',NULL,NULL,2,'yes','yes',13,'BOEM',NULL),         		
	(10,6,'CDASMidAtlantic','a','cts','ot',120,60,5,'yes','yes',15,NULL,NULL),
	(21,7,'CSAP','b','dts','ot',300,300,5,'yes','yes',31,'Manomet',NULL),
	(97,NULL,'DEandChesBaysUSFWS1990',NULL,NULL,NULL,NULL,NULL,6,'no',NULL,15,'USFWS',NULL), 					
	(175,NULL,'DeepwaterWindBlockIsland0910',NULL,NULL,NULL,NULL,NULL,9,'no',NULL,65,'BOEM',NULL), 					
	(115,8,'DOEBRIAerial2012','c','cts','ot',200,50,1,'yes','yes',3,'DOE,BRI,BOEM',NULL),--check on share levels
	(148,8,'DOEBRIAerial2013','c','cts','ot ',200,50,1,'yes','yes',3,'DOE,BRI,BOEM',NULL),--check on share levels
	(168,8,'DOEBRIAerial2014','c','cts','ot',200,50,1,'yes','yes',3,'DOE,BRI,BOEM',NULL),--check on share levels
	(157,9,'DOEBRIBoatApr2014','b','cts','ot',300,300,1,'yes','yes',3,'DOE,BRI,BOEM',NULL),
	(114,9,'DOEBRIBoatApril2012','b','cts','ot',300,300,1,'yes','yes',3,'DOE,BRI,BOEM',NULL),
	(124,9,'DOEBRIBoatAug2012','b','cts','ot',300,300,1,'yes','yes',3,'DOE,BRI,BOEM',NULL),
	(152,9,'DOEBRIBoatAug2013','b','cts','ot',300,300,1,'yes','yes',3,'DOE,BRI,BOEM',NULL),
	(125,9,'DOEBRIBoatDec2012','b','cts','ot',300,300,1,'yes','yes',3,'DOE,BRI,BOEM',NULL),
	(155,9,'DOEBRIBoatDec2013','b','cts','ot',300,300,1,'yes','yes',3,'DOE,BRI,BOEM',NULL),
	(126,9,'DOEBRIBoatJan2013','b','cts','ot',300,300,1,'yes','yes',3,'DOE,BRI,BOEM',NULL),
	(156,9,'DOEBRIBoatJan2014','b','cts','ot',300,300,1,'yes','yes',3,'DOE,BRI,BOEM',NULL),
	(127,9,'DOEBRIBoatJune2012','b','cts','ot',300,300,1,'yes','yes',3,'DOE,BRI,BOEM',NULL),
	(151,9,'DOEBRIBoatJune2013','b','cts','ot',300,300,1,'yes','yes',3,'DOE,BRI,BOEM',NULL),
	(128,9,'DOEBRIBoatMar2013','b','cts','ot',300,300,1,'yes','yes',3,'DOE,BRI,BOEM',NULL),
	(150,9,'DOEBRIBoatMay2013','b','cts','ot',300,300,1,'yes','yes',3,'DOE,BRI,BOEM',NULL),
	(130,9,'DOEBRIBoatNov2012','b','cts','ot',300,300,1,'yes','yes',3,'DOE,BRI,BOEM',NULL),
	(154,9,'DOEBRIBoatOct2013','b','cts','ot',300,300,1,'yes','yes',3,'DOE,BRI,BOEM',NULL),
	(129,9,'DOEBRIBoatSep2012','b','cts','ot',300,300,1,'yes','yes',3,'DOE,BRI,BOEM',NULL),
	(153,9,'DOEBRIBoatSep2013','b','cts','ot',300,300,1,'yes','yes',3,'DOE,BRI,BOEM',NULL),
	(134,NULL,'DominionVirginia_VOWTAP','b','cts','ot',300,300,5,'yes','yes',65,'BOEM,Dominion,TetraTech',NULL),
	(101,NULL,'DUMLOnslowBay2007',NULL,NULL,NULL,NULL,NULL,0,'no',NULL,36,'Duke, University of NC',NULL),					
	(77,10,'EcoMonAug08','b','cts','ot',300,300,5,'yes','yes',11,'NOAA',NULL),
	(42,10,'EcoMonAug09','b','cts','ot',300,300,5,'yes','yes',11,'NOAA',NULL),
	(82,10,'EcoMonAug10','b','cts','ot',300,300,5,'yes','yes',11,'NOAA',NULL),
	(112,10,'EcoMonAug2012','b','cts','ot',300,300,5,'yes','yes',11,'NOAA',NULL),
	(79,10,'EcoMonFeb10','b','cts','ot',300,300,5,'yes','yes',11,'NOAA',NULL),
	(131,10,'EcoMonFeb2012','b','cts','ot',300,300,5,'yes','yes',11,'NOAA',NULL),
	(171,10,'EcoMonFeb2013','b','cts','ot',300,300,5,'yes','yes',62,'NOAA',NULL),
	(38,10,'EcoMonJan09','b','cts','ot',300,300,5,'yes','yes',11,'NOAA',NULL),
	(158,10,'EcoMonJun2012','b','cts','ot',300,300,5,'yes','yes',11,'NOAA',NULL),
	(33,10,'EcoMonMay07','b','cts','ot',300,300,5,'yes','yes',11,'NOAA',NULL),
	(39,10,'EcoMonMay09','b','cts','ot',300,300,5,'yes','yes',11,'NOAA',NULL),
	(80,10,'EcoMonMay10','b','cts','ot',300,300,5,'yes','yes',11,'NOAA',NULL),
	(76,10,'EcoMonNov09','b','cts','ot',300,300,5,'yes','yes',11,'NOAA',NULL),
	(81,10,'EcoMonNov10','b','cts','ot',300,300,5,'yes','yes',11,'NOAA',NULL),
	(83,10,'EcoMonNov2011','b','cts','ot',300,300,5,'yes','yes',11,'NOAA',NULL),
	(159,10,'EcoMonOct2012','b','cts','ot',300,300,5,'yes','yes',11,'NOAA',NULL),
	(170,10,'EcoMonSep2012',NULL,NULL,NULL,NULL,NULL,6,'no',NULL,NULL,NULL,NULL),
	(119,15,'ECSAS','b','cts','ot',300,300,0,'no',NULL,16,NULL,NULL),
	(99,11,'FLPowerLongIsland_Aerial','a','cts','ot',400,200,5,'yes','yes',65,'BOEM, Florida Light and Power',NULL),
	(165,11,'FLPowerLongIsland_Boat','b','cts','ot',300,300,5,'yes','yes',65,'BOEM, Florida Light and Power',NULL),
	(147,NULL,'FWS_MidAtlanticDetection_Spring2012','a','cts','ot',400,200,5,'yes','no',59,'USFWS',NULL),
	(146,NULL,'FWS_SouthernBLSC_Winter2012','a','cts','ot',400,200,5,'yes','no',59,'USFWS',NULL),
	(113,NULL,'FWSAtlanticWinterSeaduck2008','a','cts','ot',400,200,5,'yes','no',58,'USFWS',NULL),
	(12,NULL,'GeorgiaPelagic','b','dts','ot',NULL,NULL,5,'yes',NULL,20,NULL,NULL),        		
	(110,NULL,'GulfOfMaineBluenose1965',NULL,NULL,NULL,NULL,NULL,0,'no',NULL,NULL,NULL,NULL),   					
	(73,NULL,'HassNC','b','tss','ot',NULL,NULL,5,'yes',NULL,42,NULL,NULL),         		
	(15,NULL,'HatterasEddyCruise2004','b','cts','ot',NULL,NULL,5,'yes',NULL,27,NULL,NULL),         		
	(78,12,'HerringAcoustic06','b','cts','ot',300,300,5,'yes','yes',11,'NOAA',NULL),
	(34,12,'HerringAcoustic07','b','cts','ot',300,300,5,'yes','yes',11,'NOAA',NULL),
	(35,12,'HerringAcoustic08','b','cts','ot',300,300,5,'yes','yes',11,'NOAA',NULL),
	(69,12,'HerringAcoustic09Leg1','b','cts','ot',300,300,5,'yes','yes',11,'NOAA',NULL),
	(70,12,'HerringAcoustic09Leg2','b','cts','ot',300,300,5,'yes','yes',11,'NOAA',NULL),
	(71,12,'HerringAcoustic09Leg3','b','cts','ot',300,300,5,'yes','yes',11,'NOAA',NULL),
	(84,12,'HerringAcoustic2010','b','cts','ot',300,300,5,'yes','yes',11,'NOAA',NULL),
	(85,12,'HerringAcoustic2011','b','cts','ot',300,300,5,'yes','yes',11,'NOAA',NULL),
	(111,12,'HerringAcoustic2012','b','cts','ot',300,300,5,'yes','yes',62,'NOAA',NULL),
	(22,NULL,'MassAudNanAerial','a','cts','ot',182,91,5,'yes','yes',10,NULL,NULL),
	(135,13,'MassCEC2011-2012','a','cts','ot',400,200,5,'yes','no',62,NULL,NULL),
	(161,13,'MassCEC2013','a','cts','ot',400,200,5,'yes','no',62,NULL,NULL),
	(162,13,'MassCEC2014','a','cts','ot',400,200,5,'yes','no',62,NULL,NULL),
	(74,NULL,'Mayr1938TransAtlantic','b','go','og',NULL,NULL,5,'yes',NULL,NULL,NULL,NULL),--check        		
	(136,13,'NantucketAerial2013','a','cts','ot',NULL,NULL,7,'yes',NULL,62,NULL,NULL),		
	(96,NULL,'NantucketShoalsLTDU1998',NULL,NULL,NULL,NULL,NULL,0,'no',NULL,NULL,NULL,NULL),					
	(105,NULL,'NCInletsDavidLee1976',NULL,NULL,NULL,NULL,NULL,0,'no',NULL,22,NULL,NULL),					
	(109,NULL,'NewEnglandBlueDolphin1953',NULL,NULL,NULL,NULL,NULL,0,'no',NULL,25,NULL,NULL),					
	(25,NULL,'NewEnglandSeamount06','b','dts','ot',NULL,NULL,5,'yes',NULL,16,NULL,NULL),        		
	(91,NULL,'NJDEP2009','b','cts','de',300,300,5,'yes','yes',56,'NJDEP,BOEM',NULL),
	(121,NULL,'NOAA/NMFS_NEFSCBoat2004','b','cts','ot',300,300,5,'yes','yes',52,'NOAA',10),
	(120,NULL,'NOAA/NMFS_NEFSCBoat2007','b','cts','ot',300,300,5,'yes','yes',52,'NOAA',11),
	(32,NULL,'NOAABycatch','b','byc','og',NULL,NULL,5,'yes',NULL,19,'NOAA',NULL),        		
	(20,NULL,'NOAAMBO7880','b','dts','ot',300,300,5,'yes','yes',15,'NOAA',NULL),   
	(173,NULL,'NYSERDA_APEM',NULL,NULL,NULL,NULL,NULL,0,'no',NULL,NULL,'BOEM,APEM',NULL),					
	(23,NULL,'Patteson','b','go','og',NULL,NULL,5,'yes',NULL,32,NULL,NULL),        		
	(92,NULL,'PIROP','b',NULL,NULL,NULL,NULL,7,'yes',NULL,16,NULL,NULL),				
	(75,NULL,'PlattsBankAerial','a','cts','ot',340,170 ,5,'yes',NULL,39,NULL,99.892),        		
	(98,NULL,'RHWiley1957',NULL,NULL,NULL,NULL,NULL,0,'no',NULL,26,NULL,NULL),					
	(89,NULL,'RISAMPAerial','a','cts','ot',300,300,5,'yes','yes',41,NULL,NULL),
	(90,NULL,'RISAMPBoat','b','cts','ot',300,300,5,'yes','yes',41,NULL,NULL),
	(104,NULL,'RockportSeawatch',NULL,NULL,NULL,NULL,NULL,0,'no',NULL,NULL,NULL,NULL),					
	(108,NULL,'RowlettMaryland1971',NULL,NULL,NULL,NULL,NULL,0,'no',NULL,24,NULL,NULL),					
	(163,NULL,'RoyalSociety',NULL,NULL,NULL,NULL,NULL,0,'no',NULL,NULL,NULL,NULL),					
	(24,NULL,'SargassoSea04','b','go','og',NULL,NULL,5,'yes',NULL,28,'Duke',NULL),	       		
	(28,NULL,'SargassoSea06','b','go','og',NULL,NULL,5,'yes',NULL,34,'Duke',NULL),	        		
	(93,NULL,'SEANET','g',NULL,NULL,NULL,NULL,0,'no',NULL,43,'Tufts,Wildlife Clinic',NULL),					
	(29,NULL,'SEFSC1992','b','cts','ot',300,300,5,'yes','yes',30,'NOAA',NULL),
	(30,NULL,'SEFSC1998','b','cts','ot',300,300,5,'yes','yes',30,'NOAA',NULL),
	(31,NULL,'SEFSC1999','b','cts','ot',300,300,5,'yes','yes',30,'NOAA',NULL),
	(133,NULL,'StatoilMaine','b','cts','ot',300,300,5,'yes','yes',65,'BOEM,StatOil,TetraTech',10),
	(95,NULL,'StellwagenBankNMS_Jun2012',NULL,NULL,NULL,NULL,NULL,99,'no',NULL,9,'NOAA',NULL),					
	(106,NULL,'WaterfowlUSFWS2001',NULL,NULL,NULL,NULL,NULL,0,'no',NULL,14,'USFWS',NULL),					
	(94,NULL,'WHOIJuly2010','b','cts','ot',300,300,1,'yes',NULL,11,'WHOI',NULL),
	(132,NULL,'WHOISept2010','b','cts','ot',300,300,1,'yes',NULL,11,'WHOI',NULL),
	(176,16,'BOEMNanoTag_Mass_Sept2013a','a','tss','ot',400,200,99,'no','yes',60,'BOEM,USFWS',NULL),
	(177,16,'BOEMNanoTag_Mass_Sept2013b','a','tss','ot',400,200,99,'no','yes',60,'BOEM,USFWS',NULL),
	(178,17,'BOEM_terns_July2013','a','tss',NULL,NULL,NULL,0,'no',NULL,62,'BOEM',100),
	(179,17,'BOEM_terns_Aug2013','a','tss',NULL,NULL,NULL,0,'no',NULL,62,'BOEM',100),
	--(180,17,'BOEM_terns_Sep2013a','a','tss',NULL,NULL,NULL,0,'no',NULL,62,'BOEM',100),
	--(180,17,'BOEM_terns_Sep2013b','a','tss',NULL,NULL,NULL,0,'no',NULL,62,'BOEM',100),
	(181,19,'StellwagenBankNMS_Aug2012',NULL,NULL,NULL,NULL,NULL,99,'no',NULL,9,'NOAA',NULL),
	(182,19,'StellwagenBankNMS_Oct2012',NULL,NULL,NULL,NULL,NULL,99,'no',NULL,9,'NOAA',NULL),
	(183,19,'StellwagenBankNMS_Jan2013',NULL,NULL,NULL,NULL,NULL,99,'no',NULL,9,'NOAA',NULL),
	(184,19,'StellwagenBankNMS_Apr2013',NULL,NULL,NULL,NULL,NULL,99,'no',NULL,9,'NOAA',NULL),
	(185,19,'StellwagenBankNMS_Jun2013',NULL,NULL,NULL,NULL,NULL,99,'no',NULL,9,'NOAA',NULL),
	(186,19,'StellwagenBankNMS_Aug2013',NULL,NULL,NULL,NULL,NULL,99,'no',NULL,9,'NOAA',NULL),
	(187,19,'StellwagenBankNMS_Oct2013',NULL,NULL,NULL,NULL,NULL,99,'no',NULL,9,'NOAA',NULL),
	(188,19,'StellwagenBankNMS_Apr2014',NULL,NULL,NULL,NULL,NULL,99,'no',NULL,9,'NOAA',NULL),
	(189,19,'StellwagenBankNMS_Jun2014',NULL,NULL,NULL,NULL,NULL,99,'no',NULL,9,'NOAA',NULL),
	(190,19,'StellwagenBankNMS_Aug2014',NULL,NULL,NULL,NULL,NULL,99,'no',NULL,9,'NOAA',NULL),
	(191,19,'StellwagenBankNMS_Sep2014',NULL,NULL,NULL,NULL,NULL,99,'no',NULL,9,'NOAA',NULL),
	(192,19,'StellwagenBankNMS_Oct2014',NULL,NULL,NULL,NULL,NULL,99,'no',NULL,9,'NOAA',NULL),
	(193,19,'StellwagenBankNMS_Dec2014',NULL,NULL,NULL,NULL,NULL,99,'no',NULL,9,'NOAA',NULL),
	(194,19,'StellwagenBankNMS_Jun2015',NULL,NULL,NULL,NULL,NULL,99,'no',NULL,9,'NOAA',NULL),
	(195,19,'StellwagenBankNMS_Aug2015',NULL,NULL,NULL,NULL,NULL,99,'no',NULL,9,'NOAA',NULL),
	(,19,'StellwagenBankNMS_Aug2011',NULL,NULL,NULL,NULL,NULL,99,'no',NULL,9,'NOAA',NULL),
	(,19,'StellwagenBankNMS_Dec2011',NULL,NULL,NULL,NULL,NULL,99,'no',NULL,9,'NOAA',NULL),
	(,19,'StellwagenBankNMS_Oct2011',NULL,NULL,NULL,NULL,NULL,99,'no',NULL,9,'NOAA',NULL),
	--(,19,'StellwagenBankNMS_Sep2011a',NULL,NULL,NULL,NULL,NULL,99,'no',NULL,9,'NOAA',NULL),
	--(,19,'StellwagenBankNMS_Sep2011b',NULL,NULL,NULL,NULL,NULL,99,'no',NULL,9,'NOAA',NULL),
	(,19,'StellwagenBankNMS_Sep2013',NULL,NULL,NULL,NULL,NULL,99,'no',NULL,9,'NOAA',NULL),
	(,19,'StellwagenBankNMS_Sep2015',NULL,NULL,NULL,NULL,NULL,99,'no',NULL,9,'NOAA',NULL),
	(,19,'StellwagenBankNMS_Oct2015',NULL,NULL,NULL,NULL,NULL,99,'no',NULL,9,'NOAA',NULL),
	(,19,'StellwagenBankNMS_Dec2015',NULL,NULL,NULL,NULL,NULL,99,'no',NULL,9,'NOAA',NULL),
	
	(,20,'StellwagenBankNMS_WW_',NULL,NULL,NULL,NULL,NULL,99,'no',NULL,9,'NOAA',NULL),
	(,20,'StellwagenBankNMS_WW_',NULL,NULL,NULL,NULL,NULL,99,'no',NULL,9,'NOAA',NULL),
	(,20,'StellwagenBankNMS_WW_',NULL,NULL,NULL,NULL,NULL,99,'no',NULL,9,'NOAA',NULL),
	(,20,'StellwagenBankNMS_WW_',NULL,NULL,NULL,NULL,NULL,99,'no',NULL,9,'NOAA',NULL),
	(,20,'StellwagenBankNMS_WW_',NULL,NULL,NULL,NULL,NULL,99,'no',NULL,9,'NOAA',NULL),
	...
	(196,10,'EcoMonMar2014','b','cts','ot',300,300,0,'no',NULL,16,'NOAA',NULL),
	(197,10,'EcoMonOct2015','b','cts','ot',300,300,0,'no',NULL,16,'NOAA',NULL),
	(198,10,'EcoMonMay2015','b','cts','ot',300,300,0,'no',NULL,16,'NOAA',NULL),
	(199,10,'EcoMonOct2016','b','cts','ot',300,300,0,'no',NULL,16,'NOAA',NULL),
	(200,10,'EcoMonMay2016','b','cts','ot',300,300,0,'no',NULL,16,'NOAA',NULL),
	(201,10,'EcoMonAug2016','b','cts','ot',300,300,0,'no',NULL,16,'NOAA',NULL),
	(202,10,'EcoMonFeb2017','b','cts','ot',300,300,0,'no',NULL,16,'NOAA',NULL),
	(203,10,'EcoMonJun2013','b','cts','ot',300,300,0,'no',NULL,16,'NOAA',NULL),
	(204,10,'EcoMonNov2013','b','cts','ot',300,300,0,'no',NULL,16,'NOAA',NULL),
	(205,10,'EcoMonFeb2011','b','cts','ot',300,300,0,'no',NULL,NULL,'NOAA',NULL),
	(206,10,'EcoMonJun2011','b','cts','ot',300,300,0,'no',NULL,NULL,'NOAA',NULL);
--
