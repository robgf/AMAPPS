...
load("Q:/Kyle_Working_Folder/Segmentation/Data/database_extract_cts_obs.RData")
# read in effort shapefile
shp = readShapeLines("Q:/Kyle_Working_Folder/Segmentation/Data/transect_shp_files/line")
