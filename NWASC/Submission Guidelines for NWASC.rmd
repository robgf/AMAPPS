...
field name | desciption    
----------|---------- 
Start_date (date/time)| start date of transect (same format as in observation table)      
Start_time (date/time)| start time of transect (same format as in observation table)       
Start_latitude(number)| start latitude of transect (same format as in observation table)       
Start_longitude (number)| start longitude of transect (same format as in observation table)   
End_date (date/time)| End date of transect (same format as in observation table)        
End_time (date/time)| End time of transect (same format as in observation table)        
End_latitude (number)| End latitude of transect (same format as in observation table)         
End_longitude (number)| End longitude of transect (same format as in observation table)        
Observer (text)| definition same as in observation table       
Observer_position (text)| definition same as in observation table       
